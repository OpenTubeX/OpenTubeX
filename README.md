...
>
> If you want to try or test it, you can download a build from [GitHub Actions](https://github.com/D3SOX/FreeTube/actions?query=workflow%3ABuild) or if you are using Arch Linux it is available on the AUR as [`freetube-git-d3sox`](https://aur.archlinux.org/packages/freetube-git-d3sox).
