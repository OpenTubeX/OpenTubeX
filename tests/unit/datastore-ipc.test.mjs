...
test('valid datastore action payloads still reach their handlers', async () => {
  ...
  const requests = [
    ...
    [IpcChannels.DB_WATCH_STATS, DBActions.WATCH_STATS.ADD_WATCH_TIME, { date: '2024-02-29', seconds: 1.5 }],
...
test('datastore write actions reject incomplete payloads before calling handlers', async () => {
  ...
  const invalidRequests = [
    ...
    [IpcChannels.DB_WATCH_STATS, DBActions.WATCH_STATS.ADD_WATCH_TIME, { date: '2026-02-29', seconds: 1.5 }],
    [IpcChannels.DB_WATCH_STATS, DBActions.WATCH_STATS.ADD_WATCH_TIME, { date: '2026-02-30', seconds: 1.5 }],
    [IpcChannels.DB_WATCH_STATS, DBActions.WATCH_STATS.ADD_WATCH_TIME, { date: '2026-99-99', seconds: 1.5 }],
