...
const IpcChannels = {
  ...
  RESTORE_CLOSED_WINDOW: 'restore-closed-window',
...
const DefaultKeyboardShortcuts = {
  APP: {
    GENERAL: {
      ...
      NEW_WINDOW: 'ctrl+N',
      RESTORE_CLOSED_WINDOW: 'ctrl+shift+N',
