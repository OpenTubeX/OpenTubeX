import { SyncLiveConnectionState, SyncCollectionCache, validateDeviceRequest, watchSyncChanges } from '../../helpers/sync-server-live'
...
import { getSyncTabRoute, removeSyncSession } from '../../helpers/sync-sessions'
import {
  AUTO_SYNC_INTERVAL_MS,
  isRecentSync,
  isSyncReasonEnabled,
} from '../../helpers/sync-server-scheduling'
import { createSyncRunner } from '../../helpers/sync-server-runner.js'
...
const runSync = createSyncRunner({
  ...
  showToastOnAllTabs,
  i18n,
  encryptedSyncRetries: ENCRYPTED_SYNC_RETRIES,
})
