...
import { getLocalShortLinkedVideo } from '../../helpers/api/local'
...
import { watchVideoMetadataMethods } from './watchVideoMetadata'
import { watchHistoryMethods } from './watchHistory'
import { watchDownloadPlaybackMethods } from './watchDownloadPlayback'
import { createWatchPlaybackOrchestration } from './watchPlaybackOrchestration'
import { createWatchPlayerRecovery } from './watchPlayerRecovery'
import { watchPlaybackSources } from './watchPlaybackSources'
import { watchPlayerLifecycle } from './watchPlayerLifecycle'
import { formatDateTime } from '../../helpers/dateFormat'

/** @typedef {import('./watchPlaybackSources').SabrData} SabrData */
...
export default defineComponent({
  ...
  methods: {
    ...
    async reloadView({ preserveTitle = false } = {}) {
      ...
      await this.loadVideoInformation(loadGeneration)
    },
    ...
    onMountedDependOnLocalStateLoading() {
      ...
      const loadGeneration = ++this.videoLoadGeneration
      this.loadVideoInformation(loadGeneration, {
        localAvailable: Boolean(process.env.SUPPORTS_LOCAL_API),
    ...
    ...createWatchPlaybackOrchestration({ supportsYtDlp, showToast }),
    ...
    ...createWatchPlayerRecovery({ supportsYtDlp, shaka, checkYtDlpPlaybackUrl, invalidateYtDlpPlaybackSource, MANIFEST_TYPE_SABR }),

    ...watchPlaybackSources,
